...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 3),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 2),
  ...
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 2),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 3),
  ...
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__members, 2),
  [54] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [56] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__members_repeat1, 2),
  [60] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__members_repeat1, 2), SHIFT_REPEAT(17),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__members, 1),
  ...
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_member, 3, .production_id = 1),
